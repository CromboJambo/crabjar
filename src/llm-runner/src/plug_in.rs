...
impl PlugInProtocol {
    ...
    pub fn create_request(&self, prompt: impl Into<String>, provenance_id: impl Into<String>) -> InferenceRequest {
        InferenceRequest::new(provenance_id, self.runner_config.runner_name.clone(), prompt)
    ...
    pub fn create_response(&self, provenance_id: impl Into<String>, output: impl Into<String>, model_name: impl Into<String>) -> InferenceResponse {
    ...
    pub fn update_config(&mut self, config: RunnerConfig) -> Result<(), crabjar_llm_plug_in::PlugInError> {
