...
fn test_cli_state_list_output() {
    ...
    assert!(output.status.success(), "crabjar state list failed: {}", String::from_utf8_lossy(&output.stderr));
...
fn test_cli_workspace_status_output() {
    ...
    assert!(output.status.success(), "crabjar workspace status failed: {}", String::from_utf8_lossy(&output.stderr));
...
fn test_cli_doctor_check_output() {
    ...
    assert!(output.status.success(), "crabjar doctor check failed: {}", String::from_utf8_lossy(&output.stderr));
...
fn test_cli_tool_list_output() {
    ...
    assert!(output.status.success(), "crabjar tool list failed: {}", String::from_utf8_lossy(&output.stderr));
...
fn test_cli_guard_queue_output() {
    ...
    assert!(output.status.success(), "crabjar guard queue failed: {}", String::from_utf8_lossy(&output.stderr));
